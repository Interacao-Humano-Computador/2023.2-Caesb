...
| 2 |  Perfil do usuário | Definição do Perfil do usuário, aspectos éticos, análise de tarefas, criação de personas e análise de tarefas | 16/10 | 17/10 |   
| 3 |   Princípios Gerais do Projeto | Definição dos princípios gerais do projeto, determinar metas de usabilidade, características da plataforma do projeto e criação do guia de estilos. | 23/10 | 24/10 |   
| 4 |  Planejamento da Avaliação do Storyboard | Planejamento do relato de resultados do storyboard, planejamento da avaliação storyboard, Planejamento do relato de resultados da avaliação da Análise de tarefas. | 30/10 | 31/10 |   
| 5   | Relato dos resultados   | Relato dos resultados do Storyboard, relatar a análise de tarefas, Planejar a avaliação do protótipo de papel, Planejar o relato dos resultados da avaliação do protótipo de papel | 08/10 | 09/11 | 
| 6.1 |  Correção e  Verificação dos Artefatos | Correção, verificação e relato dos artefatos das etapas anteriore | 15/11 | 16/11 |   
| 6.2 |  Correção e verificação dos artefatos | Correção, verificação e relato dos artefatos das etapas anteriores | 29/11 | 30/11 | 
